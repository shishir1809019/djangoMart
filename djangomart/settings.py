...
SECRET_KEY = 'django-insecure-)1dh!_c33l@4c$5dvb05d()obibxgv(gncxeu$hocviix@6_1='
...
STATIC_URL = 'static/' # that means a root
STATICFILES_DIRS = [
    BASE_DIR / 'static', #files has which directory
]
MEDIA_URL = 'media/'
